...
class MessageHandler:
    def __init__(self):
        self._response_events: Dict[str, Dict[str, asyncio.Event]] = {}
        self._response_data: Dict[str, Dict[str, dict]] = {}
    ...
    async def wait_for_response(self, client_uid: str, response_type: str, timeout: float | None = None) -> Optional[dict]:
        ...
        """
        if client_uid not in self._response_events:
            self._response_events[client_uid] = {}
            self._response_data[client_uid] = {}
    ...
    def handle_message(self, client_uid: str, message: dict):
    ...
    def cleanup_client(self, client_uid: str):
